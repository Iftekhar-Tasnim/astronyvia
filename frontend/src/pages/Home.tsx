       ...
       <div className="absolute inset-0">
        ...
        {showMaintenance && (
          <div className="absolute top-6 left-1/2 -translate-x-1/2 z-20">
            <div className="flex items-center gap-3 bg-yellow-500/15 border border-yellow-400/40 text-yellow-200 px-5 py-3 rounded-xl shadow-lg backdrop-blur-sm">
              <span className="text-lg">🛠️</span>
              <span className="text-sm md:text-base font-medium">Site is under maintenance. Some sections may be unavailable.</span>
              <button
                onClick={() => setShowMaintenance(false)}
                className="ml-2 rounded-md px-2 py-1 text-xs bg-yellow-500/20 hover:bg-yellow-500/30 transition-colors"
              >
                Close
              </button>
            </div>
