              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-200 text-sm leading-relaxed">
                      <a href="mailto:hello@astronyvia.com" className="hover:text-blue-300 transition-colors">hello@astronyvia.com</a><br />
                      <a href="mailto:support@astronyvia.com" className="hover:text-blue-300 transition-colors">support@astronyvia.com</a>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-200 text-sm leading-relaxed">
                      <a href="tel:+15551234567" className="hover:text-blue-300 transition-colors">+1 (555) 123-4567</a><br />
                      <a href="tel:+15559876543" className="hover:text-blue-300 transition-colors">+1 (555) 987-6543</a>
                    </p>
                  </div>
                </div>
              </div>
